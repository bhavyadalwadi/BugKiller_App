...
public class MainView extends SurfaceView implements SurfaceHolder.Callback {
    ...
    public MainView (Context context) {
        ...
        Assets.sound_ladybugeath = Assets.soundPool.load(context, R.raw.ladybugdeath, 1);
        Assets.sound_high_score = Assets.soundPool.load(context, R.raw.newhighscore, 1);
